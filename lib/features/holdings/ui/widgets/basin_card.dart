...
class BasinCard extends StatelessWidget {
  ...
  Widget _animateIfNeeded(final BuildContext context, final Widget child) {
    final bool animationsEnabled = !MediaQuery.of(context).disableAnimations &&
        Theme.of(context).platform != TargetPlatform.windows;
    if (!animationsEnabled) return child;
    return child
        .animate(delay: (animationIndex.clamp(0, 8) * 30).ms)
