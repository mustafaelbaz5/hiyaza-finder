...
class Parcel {
  ...
  /// assigned in `ParcelCatalogRepository.addLocalParcel`, which is now also
  ...
  /// `ParcelCatalogRepository.addLocalParcel`, for a parcel added as a sibling of
  ...
  /// (`ParcelCatalogRepository.setParcelCompleted`'s `mark_parcel_completed` RPC
  /// in particular).
