...
/// [ParcelCatalogWriter] (interface segregation) — a widget that only searches
...
abstract class ParcelCatalogReader {
  ...
  /// Returns the downloaded basin metadata for [basinName], when present.
  /// This lets the basins feature render server totals without reaching into
  /// the repository implementation or its snapshot store.
