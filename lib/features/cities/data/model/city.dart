...
/// A city/جمعية the app can download a dataset for. Only published cities
/// are ever offered to the app (`cities.is_published`, enforced both by
/// this query and by RLS server-side).
class City {
  const City({
    required this.id,
    required this.name,
